...
use crate::facades::buff_metadatas;
...
#[named]
pub async fn get_buff_metadata_list(req: ReqContext) -> ResponseResult {
    ...
    let list = buff_metadatas::get_buff_metadata_list(&slave_conn, version_id)?;
